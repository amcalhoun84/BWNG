...
exports.list = function(req, res) {
	...
	var query = db.postModel.find({is_published: false});
...
exports.listAll = function(req, res) {
	...
	exports.update = function(req, res) { 
		...
		if(post == null || post._id == null) res.send(400);

		var updatePost = {};

		if(post.title != null && post.title != "") updatePost.title = post.title;
	...
	exports.listByTag = function(req, res) { 
		...
		if(tagName == '') return res.send(400);
